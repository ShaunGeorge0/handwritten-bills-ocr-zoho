...
| Model | Vendor acc % | Bill Number acc % | Date acc % | Currency acc % | Total Amount acc % | Avg Latency (s) | Cost / Bill (USD) | Cost / 100 Bills (USD) |
|---|---|---|---|---|---|---|---|---|
| Gemini 3.6 Flash | — | — | — | — | — | — | — | — |
| Nemotron Nano 12B VL (OpenRouter, free) | — | — | — | — | — | — | 0.00 | 0.00 |
